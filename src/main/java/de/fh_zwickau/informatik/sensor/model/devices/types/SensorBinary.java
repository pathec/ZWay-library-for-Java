...
/**
 * The {@link SensorBinary} represents a sensor binary from ZAutomation API. See also:
 * http://docs.zwayhomeautomation.apiary.io/#
 *
 * @author Patrick Hecker - Initial contribution
 */
public class SensorBinary extends Device {
    @Override
    ...
    public String toString() {
        return "SensorBinary [ " + super.toString() + " ]";
    }
}
