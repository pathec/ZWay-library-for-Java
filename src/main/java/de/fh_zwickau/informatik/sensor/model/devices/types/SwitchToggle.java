...
/**
 * The {@link SwitchToggle} represents a switch toggle from ZAutomation API. See also:
 * http://docs.zwayhomeautomation.apiary.io/#
 *
 * @author Patrick Hecker - Initial contribution
 */
public class SwitchToggle extends Device {
    @Override
    public String on() {
    ...
    public String toString() {
        return "SwitchToggle [ " + super.toString() + " ]";
    }
}
